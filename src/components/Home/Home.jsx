  ...
  return (
    <div>
     <div className="_hero-section h-screen w-full flex justify-center items-center flex-col">
            ...
            <button className="text-black bg-white py-3 px-7 border-2 text-sm mt-5 lg:mt-3 hover:bg-transparent hover:border-2 hover:text-white transition-all">CHECK INVENTORY</button>
     </div>
    </div>
  );
};
